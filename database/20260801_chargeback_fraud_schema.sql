...
CREATE OR REPLACE VIEW high_chargeback_customers AS SELECT customer_id, COUNT(*) as chargeback_count FROM chargeback_transactions GROUP BY customer_id HAVING COUNT(*) > 5;
